...
def getdimfromvar (nc):
    varinfile = list(nc.variables.keys())
...
## Author : AS
def maplatlon( lon,lat,field, x = None, y = None, \
               proj="cyl",colorb="jet",ndiv=10,zeback=None,trans=0.6,title="",\
               vecx=None,vecy=None,stride=2 ):
    ###EDIT: ndiv is the number of ticks => number of levels
    ###EDIT: to compute figure, uncomment ONLY the lines with
    ...
    #TESTING; MAY NEED TO UNCOMENT THE TWO LINES BELOW
